...
<!--                         width="120px" height="120px" viewBox="0 0 52.75 41.5" enable-background="new 0 0 52.75 41.5" xml:space="preserve">-->
...
<!--            </div>-->
            ...
            <div class="sns-wrap">
                ...
                <a href="mailto:jong-wook@naver.com">
                    <img src="@/assets/img/common/mail.png" alt="" />
                </a>
                <a href="javascript:alert('서비스 준비중입니다.')">
                    <img src="@/assets/img/common/sns_insta_off.svg" alt="" />
                </a>
            </div>
