<template>
    <div>
        ...
        <div class="right-wrap">
            <div class="policy-wrap" v-if="page === 1">
                <h3>이용약관</h3>
                <pre>
                    <span>제1조(목적)</span>
                    <p>
                        이 약관은 옷썸 자상거래 사업자가 운영하는 옷썸(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
                        ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
                    </p>

                    <span>제2조(정의)</span>
                    <p>
                        ① “몰”이란 옷썸이 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                    ...
                    <p>
                        ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 옷썸의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
                    ...
                    <span>제9조(구매신청 및 개인정보 제공 동의 등)</span>
                    <p>
                    ...
                    <span>제18조(정보의 제공 및 광고의 게제)</span>
                    <p>
                    ...
                    <span>제20조(회원의 ID 및 비밀번호에 대한 의무)</span>
                    <p>
                    ...
                    <p>
                        ...
                        부 칙(시행일) 이 약관은 2019년 09월 17일부터 시행합니다.
                    </p>
                </pre>
            </div>
            <div class="policy-wrap" v-else-if="page === 2">
                <h3>개인정보처리방침</h3>
                <pre>
                    <p>
                        옷썸은(이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
                    ...
                    <p>
                        ...
                        개인정보관리책임자 성명: 김진웅, 양승철
                        전화번호: 010 6595 2468
                        이메일: jong-wook@naver.com
